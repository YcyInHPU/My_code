# -*- coding: utf-8 -*-
"""
Created on Mon Oct 17 20:53:19 2022
...
path = r'E:\XM\20220820全国水库库容模型\ML建模\ML_record_100m.xlsx'
# sheet_name='Sheet2'
sheet_name='filter2'
...
for i in range(0,10):
     ...
     train_x_reg.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\DT\Volume_key_variables_500\train_test_split/train_x_ '+ str(i) +'.csv',encoding='gb2312',index=None)
     train_y_reg=pd.DataFrame(y_train)
     train_y_reg.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\DT\Volume_key_variables_500\train_test_split/train_y_ '+ str(i) +'.csv',encoding='gb2312',index=None)
     test_x_reg=pd.DataFrame(X_test)
     test_x_reg.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\DT\Volume_key_variables_500\train_test_split/test_x_ '+ str(i) +'.csv',encoding='gb2312',index=None)
     test_y_reg=pd.DataFrame(y_test)
     test_y_reg.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\DT\Volume_key_variables_500\train_test_split/test_y_ '+ str(i) +'.csv',encoding='gb2312',index=None)
     ...
     joblib.dump(model, r'E:\XM\20220820全国水库库容模型\TEST\DT\Volume_key_variables_500\model/save_ '+ str(i) + '_model.m')
     ...
     result_pre_test.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\DT\Volume_key_variables_500\result_pre/DT_pre_test_ '+ str(i) +'.csv',encoding='gb2312',index=None)
     ans_train = model.predict(X_train)
     result_pre_train=pd.DataFrame(ans_train)
     result_pre_train.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\DT\Volume_key_variables_500\result_pre/DT_pre_train_ '+ str(i) +'.csv',encoding='gb2312',index=None)
...
validation_sta.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\DT\Volume_key_variables_500\validation_sta/DT_key_variables_validation_volume.csv',encoding='gb2312',index=None)
