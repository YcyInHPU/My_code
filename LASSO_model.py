# -*- coding: utf-8 -*-
"""
Created on Mon Oct 17 21:46:25 2022
...
for i in range(0,100):
     ...
     train_x_reg.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\LASSO\Volume_key_variables_500\train_test_split/train_x_ '+ str(i) +'.csv',encoding='gb2312',index=None)
     train_y_reg=pd.DataFrame(y_train)
     train_y_reg.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\LASSO\Volume_key_variables_500\train_test_split/train_y_ '+ str(i) +'.csv',encoding='gb2312',index=None)
     test_x_reg=pd.DataFrame(X_test)
     test_x_reg.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\LASSO\Volume_key_variables_500\train_test_split/test_x_ '+ str(i) +'.csv',encoding='gb2312',index=None)
     test_y_reg=pd.DataFrame(y_test)
     test_y_reg.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\LASSO\Volume_key_variables_500\train_test_split/test_y_ '+ str(i) +'.csv',encoding='gb2312',index=None)
     ...
     joblib.dump(model, r'E:\XM\20220820全国水库库容模型\TEST\LASSO\Volume_key_variables_500\model/save_ '+ str(i) + '_model.m')
     ...
     result_pre_test.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\LASSO\Volume_key_variables_500\result_pre/LASSO_pre_test_ '+ str(i) +'.csv',encoding='gb2312',index=None)
     ans_train = model.predict(X_train)
     result_pre_train=pd.DataFrame(ans_train)
     result_pre_train.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\LASSO\Volume_key_variables_500\result_pre/LASSO_pre_train_ '+ str(i) +'.csv',encoding='gb2312',index=None)
...
validation_sta.to_csv(r'E:\XM\20220820全国水库库容模型\TEST\LASSO\Volume_key_variables_500\validation_sta/LASSO_key_variables_validation_volume.csv',encoding='gb2312',index=None)
